...
#reseting SQL tables
c.execute("DROP TABLE parametersTable")
c.execute("DROP TABLE historicalsTable")
c.execute("DROP TABLE parametersTable2")
c.execute("DROP TABLE historicalsTable2")
c.execute("DROP TABLE logsTable")
c.execute("DROP TABLE missionsTable")
...
c.execute("INSERT INTO parametersTable (code, value, name, lastActualization, description, units, lastValue, dateType, status, maxValue, minValue)" \
                                        "VALUES (20, \'2500\' ,\'heigth\',\'" + timeStamp + "\', \'Heighness of the balloon\', \'ºC\'," \
                                        "125, \'float\',  \'OK\', 40000, -20);")

c.execute("INSERT INTO parametersTable (code, value, name, lastActualization, description, units, lastValue, dateType, status, maxValue, minValue)" \
                                        "VALUES (1, \'1\' ,\'mission\',\'" + timeStamp + "\', \'Number of STRATOS mission \', \'ºC\'," \
                                        "1, \'integer\',  \'OK\', 5, 0);")
